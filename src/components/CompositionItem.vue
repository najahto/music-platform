  ...
  <div class="border border-gray-200 p-3 mb-4 rounded">
    ...
    <div v-show="showForm">
      ...
      @submit="edit">
        ...
        :disabled="in_submition" @click.prevent="showForm = false">
          Go Back
        </button>
      </vee-form>
    </div>
...
<script>
import {
  songsCollection, storage, storageRef, deleteObject,
...
export default {
  ...
  methods: {
    ...
    async deleteSong() {
      const desertRef = storageRef(storage, `songs/${this.song.original_name}`);
